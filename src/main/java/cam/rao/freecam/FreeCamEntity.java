...
public class FreeCamEntity extends AbstractClientPlayer {
    ...
    //
    // 26.1.2 gates LivingEntity.travel(..) behind canSimulateMovement() && isEffectiveAi(),
    ...
    // same intent through getMoveSimulationType() == SERVER_AND_CLIENT; 26.1.2 has no such
