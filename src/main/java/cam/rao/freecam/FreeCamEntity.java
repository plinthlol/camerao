...
public class FreeCamEntity extends AbstractClientPlayer {
    ...
    //
    // 26.1.1 gates LivingEntity.travel(..) behind canSimulateMovement() && isEffectiveAi(),
    ...
    // same intent through getMoveSimulationType() == SERVER_AND_CLIENT; 26.1.1 has no such
